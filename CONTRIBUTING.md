...
[mukhxadnahunna.com/flutter/contributing](https://mukhxadnahunna.com/flutter/contributing).

## Reporting a problem

Open an issue in this repository:
[github.com/PG-Momik/no-nepali-profanity-flutter/issues](https://github.com/PG-Momik/no-nepali-profanity-flutter/issues). Include:

- the **exact input text**,
- which words were found, and what you expected,
- that you used the Dart and Flutter package, and the options you passed, if any.
...
`lib/src/lexicon.dart` holds the word lists, `lib/src/filter.dart` the matching logic and `lib/src/types.dart` the shared types.
...
- Add a test to `test/profanity_test.dart`: a "catches" case for something that should be flagged, and a "does not flag" case for a
